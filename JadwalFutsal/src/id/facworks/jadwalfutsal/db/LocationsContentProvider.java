...
public class LocationsContentProvider extends ContentProvider {
	...
	public static final String PROVIDER_NAME = "id.facworks.jadwalfutsal";

	/**
	 * A uri to do operations on locations table. A content provider is
	 * identified by its uri
	 */
	public static final Uri CONTENT_URI = Uri.parse("content://"
			+ PROVIDER_NAME + "/jadwalfutsal");
	...
	static {
		...
		uriMatcher.addURI(PROVIDER_NAME, "jadwalfutsal", LOCATIONS);
	}
